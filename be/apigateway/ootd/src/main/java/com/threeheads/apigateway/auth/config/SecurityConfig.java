...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .build(); // 필터 추가 없이 기본 설정으로 빌드 -> gateway는 시큐리티와 다르게 동작하기 때문에 authFilter에서 직접 수행
    }
}
