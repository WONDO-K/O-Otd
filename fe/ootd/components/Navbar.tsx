        ...
        if (isActive(['StyleView'])) {
            return (
                <>
                    <View style={styles.modalLine}>
                        ...
                        <ContentText style={styles.modalText}>메인이 되는 패션 이미지와 서브 패션 이미지를 업로드 하세요.</ContentText>
                    </View>
                    <View style={styles.modalLine}>
                        <ContentText style={styles.modalText}>2. </ContentText>
                        <ContentText style={styles.modalText}>Try! 버튼을 누르면 AI가 추천 스타일링을 제공합니다.</ContentText>
                    </View>
                </>
            );
            ...
            return (
                <>
                    <View style={styles.modalLine}>
                        <ContentText style={styles.modalText}>1. </ContentText>
                        <ContentText style={styles.modalText}>궁금한 스타일 사진을 업로드하세요.</ContentText>
                    </View>
                    <View style={styles.modalLine}>
                        <ContentText style={styles.modalText}>2. </ContentText>
                        <ContentText style={styles.modalText}>Analyze! 버튼을 눌러 업로드한 사진 어떤 스타일인지 분석 받으세요.</ContentText>
                    </View>
                    <View style={styles.modalLine}>
                        <ContentText style={styles.modalText}>3. </ContentText>
                        <ContentText style={styles.modalText}>AI는 업로드한 패션과 유사한 감각의 룩도 추천합니다.</ContentText>
                    </View>
                </>
            );
            ...
            return (
                <>
                    <View style={styles.modalLine}>
                        <ContentText style={styles.modalText}>1. </ContentText>
                        <ContentText style={styles.modalText}>Challenge! 버튼을 통해 원하는 상대와 스타일 대결을 할 수 있습니다.</ContentText>
                    </View>
                    <View style={styles.modalLine}>
                        <ContentText style={styles.modalText}>2. </ContentText>
                        <ContentText style={styles.modalText}>진행중인 대결의 경우 다른 사람들의 스타일 대결도 평가 할 수 있습니다.</ContentText>
                    </View>
                </>
            );
        }
